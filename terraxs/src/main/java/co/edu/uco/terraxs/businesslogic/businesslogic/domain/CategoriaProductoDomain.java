...
public final class CategoriaProductoDomain{
	...
	public CategoriaProductoDomain(final UUID id, final String nombre,final String descripcion) {
		setId(id);
		setNombre(nombre);
		setDescripcion(descripcion);
	}

	public static CategoriaProductoDomain obtenerValorDefecto() {
