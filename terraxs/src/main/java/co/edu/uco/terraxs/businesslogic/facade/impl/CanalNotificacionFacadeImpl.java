...
public class CanalNotificacionFacadeImpl implements CanalNotificacionFacade{
	...
	public CanalNotificacionFacadeImpl() {
		daoFactory=DAOFactory.getFactory(Factory.POSTGRE_SQL);
		canalNotificacionBusinessLogic = new CanalNotificacionBusinessLogicImpl(daoFactory);
	}

	@Override
	public void crearNotificacionPorCanal(CanalNotificacionDTO canalNotificaion) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public CanalNotificacionDTO consultarCanalNotificacionPorId(UUID id) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<CanalNotificacionDTO> consultarCanalesNotificacion(CanalNotificacionDTO filtro) {
		// TODO Auto-generated method stub
		return null;
	}
